            ...
            <div class="row flex">
                <div class="col-md-5 col-sm-12 col-xs-12">
                    <div class="topbar-left homepage-v1">
                        <div class="a">
                            <a class="hover-images" href="#"><img src="{{asset('')}}images/icon.png" alt="icon">Sms Default welcome !</a>
                        </div>
                        ...
                        <li class="level1 hassub dropdown style-menu-home-1">
                            ...
                            <div class="menu-level-1 dropdown-menu style3 dropdown-hp1">
                                <div class="row">
                                    <div class="cate-item col-md-4 col-sm-12">
                                        <div class="demo-img">
                                            <a href="" class="effect-img3 plus-zoom">
                                                <img src="{{asset('')}}images/img86.jpg" alt="" class="img-reponsive">
                                            </a>
                                        </div>
                                    ...
                                    <div class="cate-item col-md-4 col-sm-12">
                                        <div class="demo-img">
                                            <a class="effect-img3 plus-zoom" href=""><img src="{{asset('')}}images/img87.jpg" alt="" class="img-reponsive"></a>
                                        </div>
                                        <div class="demo-text text-center">New Lookbooks</div>
                                    </div>
                                    <div class="cate-item col-md-4 col-sm-12">
                                        <div class="demo-img">
                                            <a class="effect-img3 plus-zoom" href=""><img src="{{asset('')}}images/img86.jpg" alt="" class="img-reponsive"></a>
                                        </div>
                        ...
                        <div class="date mycart">
                            ...
                            <div class="dropdown-menu cart2 drop-home-1 check-out-home-1">
                                ...
                                <div class="cart-2">
                                    <div class="check-out">
                                        <div class="img-cart">
                                            <a href="#"><img src="{{asset('')}}images/img27.jpg" alt="img"></a>
                                        </div>
                                        <div class="para-cart">
                                    ...
                                    <div class="check-out">
                                        <div class="img-cart">
                                            <a href="#"><img src="{{asset('')}}images/img28.jpg" alt="img"></a>
                                        </div>
                                        <div class="para-cart">
                                    ...
                                    <div class="check-out bd-bt">
                                        <div class="img-cart">
                                            <a href="#"><img src="{{asset('')}}images/img29.jpg" alt="img"></a>
                                        </div>
                                        <div class="para-cart">
...
<section>
    <div class="about">
        <img src="{{asset('')}}images/bgr-about.jpg" alt="">
        <div class="container">
            <div class="para-about">
                {{dd($page)}}
                <h4>About Us</h4>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptat accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae<br>
                    ab illo inventore veritatis et quasi architec o beatae vitae dicta sunt explicabo. Nemo enim ipsam uptat quia voluptas sit aspernatur aut<br>
                    odit aut fugit, sed quia consequuntur magni dolores eos. Nemo enim ipsam uptat quia voluptas sit aspernatur aut odit aut fugit, sed<br>
                    quia consequuntur magni dolores eos.</p>
            </div>
        </div>
    </div>
    <div class="our">
    ...
    <div class="our-team">
        <div class="container">
            ...
            <div class="col-md-3 col-sm-2 col-sx-12 team">
                <div class="team-1">
                    <a href="" class="plus-zoom"><img src="{{asset('')}}images/team1.png" alt=""></a>
                    <p>JoAnne Theodore <br><em>Graphic Design</em></p>
                </div>
            </div>
            <div class="col-md-3 col-sm-2 col-sx-12 team">
                <div class="team-1">
                    <a href="" class="plus-zoom"><img src="{{asset('')}}images/team2.png" alt=""></a>
                    <p>Jack Brown<br><em>Graphic Design</em></p>
                </div>
            </div>
            <div class="col-md-3 col-sm-2 col-sx-12 team">
                <div class="team-1">
                    <a href="" class="plus-zoom"><img src="{{asset('')}}images/team3.png" alt=""></a>
                    <p>Johnson<br><em>Graphic Design</em></p>
                </div>
            </div>
            <div class="col-md-3 col-sm-2 col-sx-12 team">
                <div class="team-1">
                    <a href="" class="plus-zoom"><img src="{{asset('')}}images/team4.png" alt=""></a>
